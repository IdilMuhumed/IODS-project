...
#Let's check associations between chosen variables and the dependent variable. As my dependent variable is numeric and I cannot use cross-tabs I will use Pearson's correlation.
...
library(dplyr)
glimpse(pormath$alc_use)
levels(pormath$alc_use)
var_label(pormath$alc_use)
info
pormath$alc_use
install.packages("labelled")
library(labelled)
var_label(pormath$sex)
